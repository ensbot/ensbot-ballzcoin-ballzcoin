...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "ballzcoin.ipc", false, filepath.Join(os.TempDir(), "ballzcoin.ipc")},
		{"data", "ballzcoin.ipc", false, "data/ballzcoin.ipc"},
		{"data", "./ballzcoin.ipc", false, "./ballzcoin.ipc"},
		{"data", "/ballzcoin.ipc", false, "/ballzcoin.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "ballzcoin.ipc", true, `\\.\pipe\ballzcoin.ipc`},
		{"data", "ballzcoin.ipc", true, `\\.\pipe\ballzcoin.ipc`},
		{"data", `\\.\pipe\ballzcoin.ipc`, true, `\\.\pipe\ballzcoin.ipc`},
	}
