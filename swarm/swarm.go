...
import (
	...
	"github.com/ballzcoin/ballzcoin/accounts/abi/bind"
	"github.com/ballzcoin/ballzcoin/common"
	"github.com/ballzcoin/ballzcoin/contracts/chequebook"
	"github.com/ballzcoin/ballzcoin/contracts/ens"
	"github.com/ballzcoin/ballzcoin/ethclient"
	"github.com/ballzcoin/ballzcoin/metrics"
	"github.com/ballzcoin/ballzcoin/p2p"
	"github.com/ballzcoin/ballzcoin/p2p/discover"
	"github.com/ballzcoin/ballzcoin/p2p/protocols"
	"github.com/ballzcoin/ballzcoin/params"
	"github.com/ballzcoin/ballzcoin/rpc"
	"github.com/ballzcoin/ballzcoin/swarm/api"
	httpapi "github.com/ballzcoin/ballzcoin/swarm/api/http"
	"github.com/ballzcoin/ballzcoin/swarm/fuse"
	"github.com/ballzcoin/ballzcoin/swarm/log"
	"github.com/ballzcoin/ballzcoin/swarm/network"
	"github.com/ballzcoin/ballzcoin/swarm/network/stream"
	"github.com/ballzcoin/ballzcoin/swarm/pss"
	"github.com/ballzcoin/ballzcoin/swarm/state"
	"github.com/ballzcoin/ballzcoin/swarm/storage"
	"github.com/ballzcoin/ballzcoin/swarm/storage/mock"
	"github.com/ballzcoin/ballzcoin/swarm/storage/mru"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	addr := &network.BzzAddr{
		...
		UAddr: []byte(discover.NewNode(nodeID, net.IP{127, 0, 0, 1}, 31805, 31805).String()),
	}
