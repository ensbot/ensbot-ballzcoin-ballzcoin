...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/ballzcoin.ipc",
			endpoint:    "/data/testnet/ballzcoin.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/ballzcoin.ipc",
			endpoint:    "/data/testnet/ballzcoin.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/ballzcoin.ipc",
			endpoint:    "/data/testnet/ballzcoin.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/ballzcoin.ipc",
			endpoint:    "/data/testnet/ballzcoin.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
