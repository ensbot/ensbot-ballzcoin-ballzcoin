...
var (
	...
	ethPortFlag = flag.Int("ethport", 31805, "Listener port for the devp2p connection")
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/ballzcoin/ballzcoin/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
