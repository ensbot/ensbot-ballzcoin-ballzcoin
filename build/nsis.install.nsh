Name "ballzcoin ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/ballzcoin/ballzcoin/issues"
!define UPDATEURL "https://github.com/ballzcoin/ballzcoin/releases"
!define ABOUTURL "https://github.com/ballzcoin/ballzcoin#ethereum-go"
...
# Install ballzcoin binary
Section "Ballzcoin" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Ballzcoin}}
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Ballzcoin incoming peers (TCP:31805)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ballzcoin" 31805 "" "" ""
  SimpleFC::AdvAddRule "Ballzcoin outgoing peers (TCP:31805)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ballzcoin" "" 31805 "" ""
  SimpleFC::AdvAddRule "Ballzcoin UDP discovery (UDP:31805)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ballzcoin" "" 31805 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\ballzcoin.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\ballzcoin.ipc"
